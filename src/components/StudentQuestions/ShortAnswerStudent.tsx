...
interface ShortAnswerStudentProps {
  isShortAnswerVisible: Boolean;
  onBackAnswerClick: () => void;
}
...
export const ShortAnswerStudent: React.FC<ShortAnswerStudentProps> = ({
  ...
  if (!isShortAnswerVisible) {
    return null;
  }

  return (
    <ModalVideo onBackDropClick={onBackAnswerClick}>
